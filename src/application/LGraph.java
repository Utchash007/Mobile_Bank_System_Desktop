...
public class LGraph implements Initializable {
	 ...
	 static ResultSet getId;
	  @FXML
	    ...
	    void his(ActionEvent event) throws Throwable {
	    	Parent root = FXMLLoader.load(getClass().getResource("LH.fxml"));
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		try {
			...
			getId = stmt.executeQuery("select * from Loan where id = "+x+" ORDER BY `D_&_T` ASC;");
