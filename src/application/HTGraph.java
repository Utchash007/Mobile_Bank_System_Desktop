...
public class HTGraph implements Initializable {
	...
	static Connection con;
	 ...
	 ObservableList<HT>data;
	 @FXML
	    private TableColumn<HT, String> amo;

	    @FXML
	    private TableColumn<HT, String> d_t;
	    ...
	    @FXML
	    private TableColumn<HT, String> r_id;

	    @FXML
	    private TableColumn<HT, String> r_n;

	    @FXML
	    private TableColumn<HT, String> s_id;

	    @FXML
	    private TableColumn<HT, String> s_name;

	    @FXML
	    private TableView<HT> tbl;
		...
		public void initialize(URL location, ResourceBundle resources) {
			...
			try {
			 ...
			 try {
				getId = stmt.executeQuery("SELECT * FROM T_History ORDER BY `D_&_T` DESC ;");
			} catch (SQLException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
			}
			 r_id.setCellValueFactory(new PropertyValueFactory<>("receiver_ID"));
		        r_n.setCellValueFactory(new PropertyValueFactory<>("receiver_Name"));
